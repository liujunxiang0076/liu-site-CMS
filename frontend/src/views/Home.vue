    ...
    <el-dialog v-model="settingsVisible" title="安全设置" width="400px" append-to-body v-if="typeof settingsVisible !== 'undefined'">
      <el-form :model="passwordForm" label-position="top">
        ...
        <el-form-item label="新密码">
          <el-input v-model="passwordForm.newPassword" type="password" show-password @input="checkStrength"/>
          <div style="margin-top: 5px; display: flex; align-items: center; gap: 10px; width: 100%;">
            <el-progress :percentage="strengthScore" :color="strengthColor" :show-text="false" style="flex: 1"/>
            <span :style="{color: strengthColor, fontSize: '12px'}">{{ strengthText }}</span>
          </div>
        </el-form-item>
